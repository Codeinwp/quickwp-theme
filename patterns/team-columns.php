...
$images = array(
	QUICKWP_URL . 'assets/images/qwp-images-05.webp',
	QUICKWP_URL . 'assets/images/qwp-images-04.webp',
	QUICKWP_URL . 'assets/images/qwp-images-03.webp',
	QUICKWP_URL . 'assets/images/qwp-images-02.webp',
);
?>
...
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--70);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--70);padding-left:var(--wp--preset--spacing--40)">
	...
	<div class="wp-block-columns alignwide" style="padding-right:0;padding-left:0">
		...
		<div class="wp-block-column">
			...
			<figure class="wp-block-image size-full is-style-default"><img src="<?php echo esc_url( $images[0] ); ?>" alt=" " class="wp-image-236" style="aspect-ratio:1;object-fit:cover" /></figure>
			<!-- /wp:image -->
			<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|10"}},"layout":{"type":"constrained"}} -->
			<div class="wp-block-group">
		...
		<div class="wp-block-column">
			...
			<figure class="wp-block-image size-full is-style-default"><img src="<?php echo esc_url( $images[1] ); ?>" alt=" " class="wp-image-235" style="aspect-ratio:1;object-fit:cover" /></figure>
			<!-- /wp:image -->
			<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|10"}},"layout":{"type":"constrained"}} -->
			<div class="wp-block-group">
				<!-- wp:heading {"textAlign":"center","level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"600","textTransform":"uppercase"}},"fontSize":"small"} -->
		...
		<div class="wp-block-column">
			...
			<figure class="wp-block-image size-full is-style-default"><img src="<?php echo esc_url( $images[2] ); ?>" alt=" " class="wp-image-234" style="aspect-ratio:1;object-fit:cover" /></figure>
			<!-- /wp:image -->
		...
		<div class="wp-block-column">
			...
			<figure class="wp-block-image size-full is-style-default"><img src="<?php echo esc_url( $images[3] ); ?>" alt=" " class="wp-image-233" style="aspect-ratio:1;object-fit:cover" /></figure>
			<!-- /wp:image -->
