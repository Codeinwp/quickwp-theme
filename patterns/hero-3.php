...
<div class="wp-block-column" style="flex-basis:70%"><!-- wp:group {"align":"wide","layout":{"type":"constrained","justifyContent":"left"}} -->
...
<div class="wp-block-group alignwide"><!-- wp:list {"className":"is-style-checkmark-list"} -->
...
<!-- wp:column {"width":""} -->
<div class="wp-block-column"><!-- wp:paragraph {"align":"left","style":{"elements":{"link":{"color":{"text":"var:preset|color|contrast-2"}}}},"textColor":"contrast-2","fontSize":"large"} -->
...
<figure class="wp-block-image alignwide size-full is-style-default"><img src="https://quickwp.vertisite.cloud/wp-content/uploads/2024/01/qwp-img-09.webp" alt="" class="wp-image