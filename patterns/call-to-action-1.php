...
$content = new ThemeIsle\QuickWPTheme\Content( 'call-to-action-1' );
?>
...
<div class="wp-block-group alignfull has-contrast-4-color has-accent-background-color has-text-color has-background has-link-color" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--70);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--70);padding-left:var(--wp--preset--spacing--40)">
	...
	<div class="wp-block-group alignwide">
		...
		<h2 class="wp-block-heading has-text-align-left has-xx-large-font-size"><?php $content->string( 'title', 'quickwp_cta_title' ); ?></h2>
		<!-- /wp:heading -->

		<!-- wp:paragraph {"align":"left","fontSize":"large"} -->
		<p class="has-text-align-left has-large-font-size"><?php $content->string( 'subtitle', 'feature_description' ); ?></p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:group -->
	...
	<div class="wp-block-buttons alignwide">
		...
		<div class="wp-block-button has-custom-font-size is-style-fill has-large-font-size">
			<a class="wp-block-button__link has-base-3-background-color has-background wp-element-button" style="padding-top:var(--wp--preset--spacing--30);padding-right:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--30);padding-left:var(--wp--preset--spacing--60)"><?php $content->string( 'button', 'button_text_2' ); ?></a>
		</div>
		<!-- /wp:button -->
	</div>
	<!-- /wp:buttons -->
